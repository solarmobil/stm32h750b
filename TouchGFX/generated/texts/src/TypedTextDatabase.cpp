...
extern touchgfx::GeneratedFont& getFont_TacticSans_Reg_otf_20_4bpp();
extern touchgfx::GeneratedFont& getFont_TacticSansExtExd_Bld_otf_96_4bpp();
extern touchgfx::GeneratedFont& getFont_TacticSans_Reg_otf_10_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_TacticSans_Reg_otf_20_4bpp()),
    &(getFont_TacticSansExtExd_Bld_otf_96_4bpp()),
    &(getFont_TacticSans_Reg_otf_10_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_TacticSans_Reg_otf_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_TacticSansExtExd_Bld_otf_96_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_TacticSans_Reg_otf_10_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
